          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl p-8 text-white relative overflow-hidden">
                ...
                {/* Tech/AI Image - Replace with your own */}
                <div className="absolute right-4 top-4 z-20">
                  <div className="w-16 h-20 bg-white/10 rounded-lg backdrop-blur-sm border border-white/20 overflow-hidden">

                    {/* Option 2: Using regular img tag (Alternative) */}
                    <img 
                      src="/images/yu.jpg.jpg" 
                      alt="AI Technology"
